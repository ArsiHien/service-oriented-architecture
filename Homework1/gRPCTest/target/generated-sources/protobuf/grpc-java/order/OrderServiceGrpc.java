...
public final class OrderServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<order.OrderRequest,
      order.OrderResponse> METHOD_CALCULATE_TOTAL_PRICE =
      io.grpc.MethodDescriptor.<order.OrderRequest, order.OrderResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "order.OrderService", "CalculateTotalPrice"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              order.OrderRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              order.OrderResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void calculateTotalPrice(order.OrderRequest request,
        io.grpc.stub.StreamObserver<order.OrderResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_CALCULATE_TOTAL_PRICE, responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            METHOD_CALCULATE_TOTAL_PRICE,
            asyncUnaryCall(
              new MethodHandlers<
                order.OrderRequest,
                order.OrderResponse>(
                  this, METHODID_CALCULATE_TOTAL_PRICE)))
          .build();
    }
  }
  ...
  public static final class OrderServiceStub extends io.grpc.stub.AbstractStub<OrderServiceStub> {
    ...
    public void calculateTotalPrice(order.OrderRequest request,
        io.grpc.stub.StreamObserver<order.OrderResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_CALCULATE_TOTAL_PRICE, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractStub<OrderServiceBlockingStub> {
    ...
    /**
     */
    public order.OrderResponse calculateTotalPrice(order.OrderRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_CALCULATE_TOTAL_PRICE, getCallOptions(), request);
    }
  }
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractStub<OrderServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<order.OrderResponse> calculateTotalPrice(
        order.OrderRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_CALCULATE_TOTAL_PRICE, getCallOptions()), request);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALCULATE_TOTAL_PRICE:
          serviceImpl.calculateTotalPrice((order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<order.OrderResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (OrderServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_CALCULATE_TOTAL_PRICE)
              .build();
        }
      }
    }
